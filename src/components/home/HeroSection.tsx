...
const HeroSection = () => {
  ...
  const handleSelectService = (currentValue: string) => {
  ...
  const handleSubmit = () => {
    if (selectedService) {
      navigate(`/post-job?category=${encodeURIComponent(selectedService)}`);
    }
  };
            ...
            <div className="mb-6 relative max-w-lg">
              ...
              <div className="flex w-full items-center space-x-2">
                ...
                <Button
                  ...
                  className="h-14 rounded-l-none px-6 disabled:opacity-90 border border-highlight bg-highlight/95 hover:bg-highlight/90"
                >
