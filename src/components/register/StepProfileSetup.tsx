...
import { Info, ChevronRight, HardHat, MapPin, Wrench, Award } from "lucide-react";
...
const StepProfileSetup = ({ data, onUpdate, onComplete, onBack }) => {
  ...
  return (
    <div>
      <h2 className="text-3xl font-bold mb-2">Introduce yourself to future customers</h2>
      ...
      <div className="border border-primary/30 bg-primary/5 rounded-lg p-4 mb-6 flex items-start gap-3">
        ...
        <div>
          <p className="text-base">A quality description can increase your chances of getting hired.</p>
          <button
      ...
      <div className="mb-6">
        <label className="text-base font-semibold block mb-2">Company description</label>
        <Textarea
          value={description}
          onChange={(e) => {
        ...
        />
        <p className="text-sm text-muted-foreground mt-2">{remaining} characters remaining</p>
      </div>
      ...
      <Dialog open={showTips} onOpenChange={setShowTips}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle className="text-xl font-bold">Customers want to know</DialogTitle>
          </DialogHeader>
          <div className="space-y-5 mt-2">
            {[
              { icon: HardHat, title: "How long you have been working", desc: "Talk about your experience and past jobs." },
              { icon: MapPin, title: "Where you can work", desc: "Include where you work and the places you can travel for jobs." },
              { icon: Wrench, title: "What your special skills are", desc: "List skills and knowledge that show your expertise." },
              { icon: Award, title: "Why they should hire you", desc: "Share your work philosophy and why you're the best person for the job." },
            ].map((tip, i) => (
