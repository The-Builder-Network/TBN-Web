      ...
      <div className="container py-12">
        <div className=" text-center mb-16">
          <p className="text-md md:text-lg">
            ...
            registration - such as ID documents, company details, certifications
            for regulated jobs and skill assessments - allowing you to hire with
            confidence.
          </p>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="border rounded-lg p-8 bg-card">
              <div className="text-4xl mb-4">⚖️</div>
              <h3 className="text-xl font-bold mb-3">Staying up to standard</h3>
              <p className="text-muted-foreground">
                We take prompt and effective action on issues identified through
                our complaints process or monitoring activities. If someone
                doesn't meet our standards, they are removed from The Builder
                Network.
              </p>
            </div>
          </div>
