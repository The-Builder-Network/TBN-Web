...
const tradespeople = [
  {
    ...
    completedJobs: 234,
    hourlyRate: "£45-65",
    description: "Professional builder with over 15 years experience in extensions, renovations, and new builds.",
  },
  {
    id: 2,
    name: "Sarah Thompson",
    ...
    completedJobs: 189,
    hourlyRate: "£50-70",
    description: "Gas Safe registered plumber specializing in boiler installations, repairs, and bathroom plumbing.",
  },
  {
    id: 3,
    name: "Mike Davies",
    ...
    completedJobs: 156,
    hourlyRate: "£55-75",
    description: "NICEIC approved electrician. Full and partial rewires, consumer units, EV charger installations.",
  },
  {
    id: 4,
    name: "Emma Roberts",
    ...
    completedJobs: 203,
    hourlyRate: "£35-50",
    description: "Professional painter and decorator with a keen eye for detail. Interior and exterior work.",
  },
  {
    id: 5,
    name: "Tom Harrison",
    ...
    completedJobs: 145,
    hourlyRate: "£40-60",
    description: "All aspects of roofing undertaken. Flat roofs, pitched roofs, lead work, and repairs.",
  },
  {
    id: 6,
    name: "Lisa Chen",
    ...
    completedJobs: 98,
    hourlyRate: "£45-65",
    description: "Bespoke carpentry and joinery. Fitted furniture, kitchens, and restoration work.",
  },
];
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
                  <div>
                    ...
                    <p className="text-muted-foreground">{tradespeople.length} professionals found</p>
                  </div>
                        ...
                        <div className={viewMode === "list" 
                          ...
                          {viewMode === "grid" && (
                            <div className="flex-1 min-w-0">
                              ...
                              <p className="text-sm font-medium text-primary mt-1">{person.trade}</p>
                            </div>
                          )}
                        </div>
