        ...
        <section className="bg-muted py-16">
          <div className="container">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl">
              ...
              us what you need, and our clever match-making process will help
              you choose the right person for your job with confidence.
            </p>
          </div>
        </section>
          ...
          <div className="container">
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <a href="/post-job" className="text-center group cursor-pointer">
                ...
                <h3 className="text-xl font-semibold mb-2 group-hover:text-primary transition-colors">Post a job</h3>
              ...
              <a href="/tradespeople" className="text-center group cursor-pointer">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-primary/10 mb-4 group-hover:bg-primary/20 transition-colors">
                ...
                <p className="text-muted-foreground">
                  ...
                  alerts relevant tradespeople, who can then express interest in
                  your job.
                </p>
              </a>
              ...
              <div className="bg-background p-6 rounded-lg border">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Review profiles, work history, and customer feedback to
                      make an informed decision before contacting anyone.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-background p-6 rounded-lg border">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      All tradespeople on our platform are verified with
                      coverage checks, helping you choose a builder you can
                      trust.
                    </p>
                  </div>
                </div>
          ...
          <div className="container">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  After your job is complete, you can leave a review based on
                  your experience. Our review system ensures that tradespeople
                  are rewarded for good work and held accountable for any
                  problems.
                </p>
              </div>
              <div className="bg-muted rounded-lg overflow-hidden h-64 shadow-md">
